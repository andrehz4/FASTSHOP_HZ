...
Login com sucesso na FastShop 
                        #CPF            #SENHA          #STATUS
    Logar na FastShop   94186183031     12345678        201        

Login com senha inválida na FastShop 
                        #CPF            #SENHA          #STATUS
    Logar na FastShop   94186183031     123456789       404 
...
Login com cpf em branco na FastShop 
                        #CPF            #SENHA          #STATUS
    Logar na FastShop   94186183031     ${EMPTY}        404    

Login com cpf e senha em branco na FastShop 
    Logar na FastShop   ${EMPTY}        ${EMPTY}        404    

Visualizar o carrinho FASTSHOP
    Visualizar o carrinho FASTSHOP   94186183031     12345678    

Deletar dois produtos do carrinho FastShop
                                                      #CPF            #SENHA          #PRODUTO1           #PRODUTO2
    Deletar dois produtos do carrinho FastShop        94186183031     12345678        PANAF160B5W1        8S311310222PTO    
